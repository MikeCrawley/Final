...
<div id = "content">
	<p>
		Every scarf in our store was handmade by trained staff with more knowledge in their fingertips then 
		chain-store personnel have in their whole body.  We have almost every color and variety available including
		black and red, grey and taupe, aqua, maroon, pink, and navy just to name a few.
	</p>
	<img class = "products" alt="Happy Customer" src="images/happy.jpg">
	<p>
		Are you looking for cool designs, we have them.  Everyone's favorite magazine 'Scarfs Scarfs Scarfs' voted us the number
		one scarf store in the world.  Enroll today so that you can experience firsthand what it 
		is like to own a scarf from the number 1 scarf store on the web.
	</p>
	</div>
<div id = "sidebar">
